...
from app.schemas.user_schemas import UserSchema, UserLoginSchema, UserResponseScema, UserLoginResponseSchema
...
@user_router.post("/register", response_model=UserResponseScema)
