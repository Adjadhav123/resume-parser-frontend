    ...
    <>
      ...
      <nav>
        ...
        <div className="nav-actions">
          ...
          <button className="btn btn-primary" onClick={() => onNavigate('/admin/register')}>
            Sign Up
          </button>
        </div>
      </nav>
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <p className="auth-subtitle">
            Sign in to your admin account to manage job postings.
          </p>
          ...
          <p className="auth-switch">
            ...
            <button className="auth-link" style={{background: 'none', border: 'none', padding: 0, cursor: 'pointer', font: 'inherit'}} onClick={() => onNavigate('/admin/register')}>
              Create one
            </button>
          </p>
        </div>
